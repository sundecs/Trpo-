...
namespace FL
{
    public partial class Form3 : Form
    {
        ...
        public Form3(string path, string dict_name)
        {
            InitializeComponent();

            this.path = path;
            this.Text = "Learning: \'" + dict_name + "\'.";
            
            label1.Text = "Match the words and translations.";
        ...
        // left-hand side labels with source words
        ...
        // right-hand side labels with translations
        ...
        // fill labels with words and translations
        ...
        private void Check()
        {
            if (left_selected == right_selected)
            {
                ...
                if (correct == 10 + words)
                {
                    ...
                    {
                        if (MessageBox.Show("Would you like to start over?", "Learning session complete",
